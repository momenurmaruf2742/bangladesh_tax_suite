...
class TaxRepository:
    ...
    async def get_by_employee_and_year(self, employee_id: uuid.UUID, financial_year: str) -> TaxCalculation | None:
    ...
    async def get_history_by_employee(self, employee_id: uuid.UUID) -> list[TaxCalculation]:
    ...
    async def create(self, employee_id: uuid.UUID, calc: TaxCalculation) -> TaxCalculation:
